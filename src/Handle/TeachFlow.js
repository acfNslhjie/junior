...
teach_flow = [
              ...
              {tip:"将1号和4号试管放到10℃水温烧杯中,水浴5分钟",tag:[TAG_SHIGUAN1_NODE,TAG_SHIGUAN1],action:ACTION_DO1},
              {tip:"将1号和4号试管放到10℃水温烧杯中,水浴5分钟",tag:[TAG_SHIGUAN4_NODE,TAG_SHIGUAN4],action:ACTION_DO1},
              {tip:"将2号和5号试管放到37℃水温烧杯中,水浴5分钟",tag:[TAG_SHIGUAN2_NODE,TAG_SHIGUAN2],action:ACTION_DO1},
              {tip:"将2号和5号试管放到37℃水温烧杯中,水浴5分钟",tag:[TAG_SHIGUAN5_NODE,TAG_SHIGUAN5],action:ACTION_DO1},
              {tip:"将3号和6号试管放到60℃水温烧杯中,水浴5分钟",tag:[TAG_SHIGUAN3_NODE,TAG_SHIGUAN3],action:ACTION_DO1},              
              {tip:"将3号和6号试管放到60℃水温烧杯中,水浴5分钟",tag:[TAG_SHIGUAN6_NODE,TAG_SHIGUAN6],action:ACTION_DO1},              
              {tip:"将4号试管中的唾液淀粉酶溶液倒入1号试管,水浴5分钟",tag:[TAG_SHIGUAN4_NODE,TAG_SHIGUAN4],action:ACTION_DO2},
              {tip:"将5号试管中的唾液淀粉酶溶液倒入2号试管,水浴5分钟",tag:[TAG_SHIGUAN5_NODE,TAG_SHIGUAN5],action:ACTION_DO2},
              {tip:"将6号试管中的唾液淀粉酶溶液倒入3号试管,水浴5分钟",tag:[TAG_SHIGUAN6_NODE,TAG_SHIGUAN6],action:ACTION_DO2},
                {tip:"取出碘溶液",tag:[TAG_LIB,TAG_LIB_DROP3]},
                {tip:"取出1号试管",tag:[TAG_SHIGUAN1_NODE,TAG_SHIGUAN1],action:ACTION_DO2},
                {tip:"在1号试管中添加1滴碘液",tag:[TAG_DROP_NODE,TAG_DROP],action:ACTION_DO1},
